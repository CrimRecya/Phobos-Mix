...
Trajectory.Missile.OffsetCoord=0,0,0         ; FLH坐标，请写完整，抛体目标位置的额外偏移，抛体会瞄准目标的这个相对坐标进行攻击，支持在此基础上启用随机散布
...
Trajectory.Tracing.SuicideAboveRange=no      ; 布尔值，抛体如果距离发射者超过射程是否直接引爆
```
