...
- In addition, this type of projectile also has some general functions for launching weapons and detonating warheads.
...
- Make sure you set a low `Trajectory.ProximityRadius` and `Trajectory.RetargetRadius` value unless necessary.
